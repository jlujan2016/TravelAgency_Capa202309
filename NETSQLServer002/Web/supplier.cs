   ...
   public class supplier : GXDataArea
   {
      ...
      protected void ZM0A13( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z49SupplierName = T000A3_A49SupplierName[0];
               Z50SupplierAddress = T000A3_A50SupplierAddress[0];
            }
            else
            {
      ...
      protected void Load0A13( )
      {
         ...
         {
            RcdFound13 = 1;
            A49SupplierName = T000A4_A49SupplierName[0];
            AssignAttri("", false, "A49SupplierName", A49SupplierName);
            A50SupplierAddress = T000A4_A50SupplierAddress[0];
            AssignAttri("", false, "A50SupplierAddress", A50SupplierAddress);
            ZM0A13( -1) ;
         }
         pr_default.close(2);
      ...
      {
         /* Using cursor T000A3 */
         pr_default.execute(1, new Object[] {A48SupplierId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM0A13( 1) ;
            RcdFound13 = 1;
            A48SupplierId = T000A3_A48SupplierId[0];
            AssignAttri("", false, "A48SupplierId", StringUtil.LTrimStr( (decimal)(A48SupplierId), 4, 0));
            A49SupplierName = T000A3_A49SupplierName[0];
            AssignAttri("", false, "A49SupplierName", A49SupplierName);
            A50SupplierAddress = T000A3_A50SupplierAddress[0];
            AssignAttri("", false, "A50SupplierAddress", A50SupplierAddress);
            Z48SupplierId = A48SupplierId;
            sMode13 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T000A6_A48SupplierId[0] < A48SupplierId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T000A6_A48SupplierId[0] > A48SupplierId ) ) )
            {
               A48SupplierId = T000A6_A48SupplierId[0];
               AssignAttri("", false, "A48SupplierId", StringUtil.LTrimStr( (decimal)(A48SupplierId), 4, 0));
               RcdFound13 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T000A7_A48SupplierId[0] > A48SupplierId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T000A7_A48SupplierId[0] < A48SupplierId ) ) )
            {
               A48SupplierId = T000A7_A48SupplierId[0];
               AssignAttri("", false, "A48SupplierId", StringUtil.LTrimStr( (decimal)(A48SupplierId), 4, 0));
               RcdFound13 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency0A13( )
      {
         ...
         {
            /* Using cursor T000A2 */
            pr_default.execute(0, new Object[] {A48SupplierId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z49SupplierName, T000A2_A49SupplierName[0]) != 0 ) || ( StringUtil.StrCmp(Z50SupplierAddress, T000A2_A50SupplierAddress[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z49SupplierName, T000A2_A49SupplierName[0]) != 0 )
               {
                  GXUtil.WriteLog("supplier:[seudo value changed for attri]"+"SupplierName");
                  GXUtil.WriteLogRaw("Old: ",Z49SupplierName);
                  GXUtil.WriteLogRaw("Current: ",T000A2_A49SupplierName[0]);
               }
               if ( StringUtil.StrCmp(Z50SupplierAddress, T000A2_A50SupplierAddress[0]) != 0 )
               {
                  GXUtil.WriteLog("supplier:[seudo value changed for attri]"+"SupplierAddress");
                  GXUtil.WriteLogRaw("Old: ",Z50SupplierAddress);
                  GXUtil.WriteLogRaw("Current: ",T000A2_A50SupplierAddress[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T000A8 */
                     pr_default.execute(6, new Object[] {A49SupplierName, A50SupplierAddress});
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T000A9 */
                     pr_default.execute(7, new Object[] {A49SupplierName, A50SupplierAddress, A48SupplierId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Supplier");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {A48SupplierId});
                  pr_default.close(8);
                  pr_default.SmartCacheProvider.SetUpdated("Supplier");
                  if ( AnyError == 0 )
                  {
      ...
      public void ScanStart0A13( )
      {
         ...
         {
            RcdFound13 = 1;
            A48SupplierId = T000A11_A48SupplierId[0];
            AssignAttri("", false, "A48SupplierId", StringUtil.LTrimStr( (decimal)(A48SupplierId), 4, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202392112394153", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("supplier.js", "?202392112394153", false, true);
      ...
      public override void initialize( )
      {
         ...
         T000A3_A48SupplierId = new short[1] ;
         T000A3_A49SupplierName = new string[] {""} ;
         T000A3_A50SupplierAddress = new string[] {""} ;
         sMode13 = "";
         T000A6_A48SupplierId = new short[1] ;
         T000A7_A48SupplierId = new short[1] ;
         T000A2_A48SupplierId = new short[1] ;
         T000A2_A49SupplierName = new string[] {""} ;
         T000A2_A50SupplierAddress = new string[] {""} ;
         T000A8_A48SupplierId = new short[1] ;
         T000A11_A48SupplierId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ49SupplierName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier__default(),
            new Object[][] {
                new Object[] {
               T000A2_A48SupplierId, T000A2_A49SupplierName, T000A2_A50SupplierAddress
               }
               , new Object[] {
               T000A3_A48SupplierId, T000A3_A49SupplierName, T000A3_A50SupplierAddress
               }
               , new Object[] {
               T000A4_A48SupplierId, T000A4_A49SupplierName, T000A4_A50SupplierAddress
               }
               , new Object[] {
               T000A5_A48SupplierId
               }
               , new Object[] {
               T000A6_A48SupplierId
               }
               , new Object[] {
      ...
      private short[] T000A3_A48SupplierId ;
      private string[] T000A3_A49SupplierName ;
      private string[] T000A3_A50SupplierAddress ;
      private short[] T000A6_A48SupplierId ;
      private short[] T000A7_A48SupplierId ;
      private short[] T000A2_A48SupplierId ;
      private string[] T000A2_A49SupplierName ;
      private string[] T000A2_A50SupplierAddress ;
      private short[] T000A8_A48SupplierId ;
      private short[] T000A11_A48SupplierId ;
   ...
   public class supplier__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T000A2", "SELECT [SupplierId], [SupplierName], [SupplierAddress] FROM [Supplier] WITH (UPDLOCK) WHERE [SupplierId] = @SupplierId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000A2,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000A3", "SELECT [SupplierId], [SupplierName], [SupplierAddress] FROM [Supplier] WHERE [SupplierId] = @SupplierId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000A3,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000A4", "SELECT TM1.[SupplierId], TM1.[SupplierName], TM1.[SupplierAddress] FROM [Supplier] TM1 WHERE TM1.[SupplierId] = @SupplierId ORDER BY TM1.[SupplierId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000A4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000A5", "SELECT [SupplierId] FROM [Supplier] WHERE [SupplierId] = @SupplierId  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000A5,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000A6", "SELECT TOP 1 [SupplierId] FROM [Supplier] WHERE ( [SupplierId] > @SupplierId) ORDER BY [SupplierId]  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000A6,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000A7", "SELECT TOP 1 [SupplierId] FROM [Supplier] WHERE ( [SupplierId] < @SupplierId) ORDER BY [SupplierId] DESC  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000A7,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000A8", "INSERT INTO [Supplier]([SupplierName], [SupplierAddress]) VALUES(@SupplierName, @SupplierAddress); SELECT SCOPE_IDENTITY()",true, GxErrorMask.GX_NOMASK, false, this,prmT000A8,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000A9", "UPDATE [Supplier] SET [SupplierName]=@SupplierName, [SupplierAddress]=@SupplierAddress  WHERE [SupplierId] = @SupplierId", GxErrorMask.GX_NOMASK,prmT000A9)
             ,new CursorDef("T000A10", "DELETE FROM [Supplier]  WHERE [SupplierId] = @SupplierId", GxErrorMask.GX_NOMASK,prmT000A10)
             ,new CursorDef("T000A11", "SELECT [SupplierId] FROM [Supplier] ORDER BY [SupplierId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000A11,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
