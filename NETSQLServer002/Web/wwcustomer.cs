...
namespace GeneXus.Programs {
   public class wwcustomer : GXDataArea
   {
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCustomer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A16CustomerAddedDate = H000A2_A16CustomerAddedDate[0];
               A6CustomerEmail = H000A2_A6CustomerEmail[0];
               A5CustomerPhone = H000A2_A5CustomerPhone[0];
               A4CustomerAddress = H000A2_A4CustomerAddress[0];
               A3CustomerLastName = H000A2_A3CustomerLastName[0];
               A2CustomerName = H000A2_A2CustomerName[0];
               A1CustomerId = H000A2_A1CustomerId[0];
               E140A2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CUSTOMERID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"), context));
      }
      ...
      private void E140A2( )
      {
         ...
         edtCustomerName_Link = formatLink("viewcustomer.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1CustomerId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"CustomerId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20239161721121", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcustomer.js", "?20239161721121", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtCustomerLastName_Internalname = "CUSTOMERLASTNAME_"+sGXsfl_27_idx;
         edtCustomerAddress_Internalname = "CUSTOMERADDRESS_"+sGXsfl_27_idx;
         edtCustomerPhone_Internalname = "CUSTOMERPHONE_"+sGXsfl_27_idx;
         edtCustomerEmail_Internalname = "CUSTOMEREMAIL_"+sGXsfl_27_idx;
         edtCustomerAddedDate_Internalname = "CUSTOMERADDEDDATE_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtCustomerLastName_Internalname = "CUSTOMERLASTNAME_"+sGXsfl_27_fel_idx;
         edtCustomerAddress_Internalname = "CUSTOMERADDRESS_"+sGXsfl_27_fel_idx;
         ...
         edtCustomerAddedDate_Internalname = "CUSTOMERADDEDDATE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerLastName_Internalname,(string)A3CustomerLastName,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerLastName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerAddress_Internalname,(string)A4CustomerAddress,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4CustomerAddress),(string)"_blank",(string)"",(string)"",(string)edtCustomerAddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerAddedDate_Internalname,context.localUtil.Format(A16CustomerAddedDate, "99/99/99"),context.localUtil.Format( A16CustomerAddedDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerAddedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A2CustomerName));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtCustomerName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A3CustomerLastName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A4CustomerAddress));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A5CustomerPhone)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A6CustomerEmail));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A16CustomerAddedDate, "99/99/99")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140A2',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110A2',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11CustomerName = "";
         H000A2_A16CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         H000A2_A6CustomerEmail = new string[] {""} ;
         H000A2_A5CustomerPhone = new string[] {""} ;
         H000A2_A4CustomerAddress = new string[] {""} ;
         H000A2_A3CustomerLastName = new string[] {""} ;
         H000A2_A2CustomerName = new string[] {""} ;
         H000A2_A1CustomerId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcustomer__default(),
            new Object[][] {
                new Object[] {
               H000A2_A16CustomerAddedDate, H000A2_A6CustomerEmail, H000A2_A5CustomerPhone, H000A2_A4CustomerAddress, H000A2_A3CustomerLastName, H000A2_A2CustomerName, H000A2_A1CustomerId
               }
               , new Object[] {
      ...
      private DateTime[] H000A2_A16CustomerAddedDate ;
      private string[] H000A2_A6CustomerEmail ;
      private string[] H000A2_A5CustomerPhone ;
      private string[] H000A2_A4CustomerAddress ;
      private string[] H000A2_A3CustomerLastName ;
      private string[] H000A2_A2CustomerName ;
      private short[] H000A2_A1CustomerId ;
   ...
   public class wwcustomer__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A2CustomerName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [CustomerAddedDate], [CustomerEmail], [CustomerPhone], [CustomerAddress], [CustomerLastName], [CustomerName], [CustomerId]";
         sFromString = " FROM [Customer]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11CustomerName)) )
         {
            AddWhere(sWhereString, "([CustomerName] like @lV11CustomerName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [CustomerName]";
