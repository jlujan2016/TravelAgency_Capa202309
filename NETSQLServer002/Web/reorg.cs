...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeFlight( )
      {
         ...
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Flight] DROP CONSTRAINT FlightDiscountPercentajeFlight_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"FlightDiscountPercentaje", "Flight"}) ) ;
            return false ;
         }
         return true ;
      }
