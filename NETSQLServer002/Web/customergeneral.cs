...
namespace GeneXus.Programs {
   public class customergeneral : GXWebComponent
   {
      ...
      {
         this.A1CustomerId = aP0_CustomerId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A1CustomerId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customergeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1CustomerId,4,0))}, new string[] {"CustomerId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA1CustomerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA1CustomerId), 4, 0, ".", "")));
      }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110b1_client"+"'", TempTags, "", 2, "HLP_CustomerGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120b1_client"+"'", TempTags, "", 2, "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CustomerId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCustomerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9") : context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, A2CustomerName, StringUtil.RTrim( context.localUtil.Format( A2CustomerName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtCustomerLastName_Internalname, "Last Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerLastName_Internalname, A3CustomerLastName, StringUtil.RTrim( context.localUtil.Format( A3CustomerLastName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerLastName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerLastName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtCustomerAddress_Internalname, A4CustomerAddress, "http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4CustomerAddress), "", 0, 1, edtCustomerAddress_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "1024", -1, 0, "_blank", "", 0, true, "GeneXus\\Address", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerPhone_Internalname, StringUtil.RTrim( A5CustomerPhone), StringUtil.RTrim( context.localUtil.Format( A5CustomerPhone, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", gxphoneLink, "", "", "", edtCustomerPhone_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerPhone_Enabled, 0, "tel", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Phone", "start", true, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerEmail_Internalname, A6CustomerEmail, StringUtil.RTrim( context.localUtil.Format( A6CustomerEmail, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "mailto:"+A6CustomerEmail, "", "", "", edtCustomerEmail_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "start", true, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtCustomerAddedDate_Internalname, "Added Date", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerAddedDate_Internalname, context.localUtil.Format(A16CustomerAddedDate, "99/99/99"), context.localUtil.Format( A16CustomerAddedDate, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerAddedDate_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerAddedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_bitmap( context, edtCustomerAddedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtCustomerAddedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_CustomerGeneral.htm");
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A16CustomerAddedDate = H000B2_A16CustomerAddedDate[0];
               AssignAttri(sPrefix, false, "A16CustomerAddedDate", context.localUtil.Format(A16CustomerAddedDate, "99/99/99"));
               A6CustomerEmail = H000B2_A6CustomerEmail[0];
               AssignAttri(sPrefix, false, "A6CustomerEmail", A6CustomerEmail);
               A5CustomerPhone = H000B2_A5CustomerPhone[0];
               AssignAttri(sPrefix, false, "A5CustomerPhone", A5CustomerPhone);
               A4CustomerAddress = H000B2_A4CustomerAddress[0];
               AssignAttri(sPrefix, false, "A4CustomerAddress", A4CustomerAddress);
               A3CustomerLastName = H000B2_A3CustomerLastName[0];
               AssignAttri(sPrefix, false, "A3CustomerLastName", A3CustomerLastName);
               A2CustomerName = H000B2_A2CustomerName[0];
               AssignAttri(sPrefix, false, "A2CustomerName", A2CustomerName);
               /* Execute user event: Load */
               E140B2 ();
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA1CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1CustomerId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A1CustomerId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA1CustomerId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A1CustomerId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
         }
         wcpOA1CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1CustomerId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A1CustomerId != wcpOA1CustomerId ) ) )
         {
            setjustcreated();
         }
         wcpOA1CustomerId = A1CustomerId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA1CustomerId = cgiGet( sPrefix+"A1CustomerId_CTRL");
         if ( StringUtil.Len( sCtrlA1CustomerId) > 0 )
         {
            A1CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA1CustomerId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
         }
         else
         {
            A1CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A1CustomerId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A1CustomerId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CustomerId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA1CustomerId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A1CustomerId_CTRL", StringUtil.RTrim( sCtrlA1CustomerId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202391617202366", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("customergeneral.js", "?202391617202367", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtCustomerLastName_Internalname = sPrefix+"CUSTOMERLASTNAME";
         ...
         edtCustomerAddedDate_Internalname = sPrefix+"CUSTOMERADDEDDATE";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E110B1',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120B1',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000B2_A1CustomerId = new short[1] ;
         H000B2_A16CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         H000B2_A6CustomerEmail = new string[] {""} ;
         H000B2_A5CustomerPhone = new string[] {""} ;
         H000B2_A4CustomerAddress = new string[] {""} ;
         H000B2_A3CustomerLastName = new string[] {""} ;
         H000B2_A2CustomerName = new string[] {""} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customergeneral__default(),
            new Object[][] {
                new Object[] {
               H000B2_A1CustomerId, H000B2_A16CustomerAddedDate, H000B2_A6CustomerEmail, H000B2_A5CustomerPhone, H000B2_A4CustomerAddress, H000B2_A3CustomerLastName, H000B2_A2CustomerName
               }
            }
         );
         AV11Pgmname = "CustomerGeneral";
      ...
      private short wcpOA1CustomerId ;
      ...
      private string sCtrlA1CustomerId ;
      ...
      private short[] H000B2_A1CustomerId ;
      private DateTime[] H000B2_A16CustomerAddedDate ;
      private string[] H000B2_A6CustomerEmail ;
      private string[] H000B2_A5CustomerPhone ;
      private string[] H000B2_A4CustomerAddress ;
      private string[] H000B2_A3CustomerLastName ;
      private string[] H000B2_A2CustomerName ;
   ...
   public class customergeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT [CustomerId], [CustomerAddedDate], [CustomerEmail], [CustomerPhone], [CustomerAddress], [CustomerLastName], [CustomerName] FROM [Customer] WHERE [CustomerId] = @CustomerId ORDER BY [CustomerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
