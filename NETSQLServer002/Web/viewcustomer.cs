...
namespace GeneXus.Programs {
   public class viewcustomer : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("CustomerName", StringUtil.RTrim( context.localUtil.Format( A2CustomerName, "")));
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, A2CustomerName, StringUtil.RTrim( context.localUtil.Format( A2CustomerName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewCustomer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF092( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1CustomerId = H00092_A1CustomerId[0];
               A2CustomerName = H00092_A2CustomerName[0];
      ...
      protected void E11092( )
      {
         ...
         {
            A1CustomerId = H00093_A1CustomerId[0];
            A2CustomerName = H00093_A2CustomerName[0];
            AssignAttri("", false, "A2CustomerName", A2CustomerName);
            AV14GXLvl7 = 1;
            Form.Caption = A2CustomerName;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20239161721297", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcustomer.js", "?20239161721298", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2CustomerName',fld:'CUSTOMERNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV13Pgmname = "";
         scmdbuf = "";
         H00092_A1CustomerId = new short[1] ;
         H00092_A2CustomerName = new string[] {""} ;
         hsh = "";
         H00093_A1CustomerId = new short[1] ;
         H00093_A2CustomerName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcustomer__default(),
            new Object[][] {
                new Object[] {
               H00092_A1CustomerId, H00092_A2CustomerName
               }
               , new Object[] {
               H00093_A1CustomerId, H00093_A2CustomerName
               }
            }
         );
      ...
      private short[] H00092_A1CustomerId ;
      private string[] H00092_A2CustomerName ;
      private short[] H00093_A1CustomerId ;
      private string[] H00093_A2CustomerName ;
   ...
   public class viewcustomer__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00092", "SELECT [CustomerId], [CustomerName] FROM [Customer] WHERE [CustomerId] = @AV12CustomerId ORDER BY [CustomerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00092,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00093", "SELECT [CustomerId], [CustomerName] FROM [Customer] WHERE [CustomerId] = @AV12CustomerId ORDER BY [CustomerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00093,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
