...
namespace GeneXus.Programs {
   public class gx0020 : GXDataArea
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cAttractionId, AV7cAttractionName, AV10cCountryId, AV11cCategoryId) ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40000AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_54_Refreshing);
      ...
      protected void RF042( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00042 */
            pr_default.execute(0, new Object[] {AV6cAttractionId, lV7cAttractionName, AV10cCountryId, AV11cCategoryId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_54_idx = 1;
            sGXsfl_54_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_54_idx), 4, 0), 4, "0");
            SubsflControlProps_542( ) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ATTRACTIONID"+"_"+sGXsfl_54_idx, GetSecureSignedToken( sGXsfl_54_idx, context.localUtil.Format( (decimal)(A7AttractionId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cAttractionName = StringUtil.Concat( StringUtil.RTrim( AV7cAttractionName), "%", "");
         /* Using cursor H00043 */
         pr_default.execute(1, new Object[] {AV6cAttractionId, lV7cAttractionName, AV10cCountryId, AV11cCategoryId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202391211501244", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0020.js", "?202391211501244", false, true);
      ...
      protected void SubsflControlProps_542( )
      {
         ...
         edtAttractionId_Internalname = "ATTRACTIONID_"+sGXsfl_54_idx;
         edtAttractionName_Internalname = "ATTRACTIONNAME_"+sGXsfl_54_idx;
         edtCountryId_Internalname = "COUNTRYID_"+sGXsfl_54_idx;
         edtCategoryId_Internalname = "CATEGORYID_"+sGXsfl_54_idx;
         edtAttractionPhoto_Internalname = "ATTRACTIONPHOTO_"+sGXsfl_54_idx;
      }

      protected void SubsflControlProps_fel_542( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_54_fel_idx;
         edtAttractionId_Internalname = "ATTRACTIONID_"+sGXsfl_54_fel_idx;
         edtAttractionName_Internalname = "ATTRACTIONNAME_"+sGXsfl_54_fel_idx;
         edtCountryId_Internalname = "COUNTRYID_"+sGXsfl_54_fel_idx;
         edtCategoryId_Internalname = "CATEGORYID_"+sGXsfl_54_fel_idx;
         edtAttractionPhoto_Internalname = "ATTRACTIONPHOTO_"+sGXsfl_54_fel_idx;
      }
      ...
      protected void sendrow_542( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_54_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, edtAttractionName_Internalname, "Link", edtAttractionName_Link, !bGXsfl_54_Refreshing);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E18042',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Attractionphoto',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0020__default(),
            new Object[][] {
                new Object[] {
               H00042_A40000AttractionPhoto_GXI, H00042_A11CategoryId, H00042_A9CountryId, H00042_A8AttractionName, H00042_A7AttractionId, H00042_A13AttractionPhoto
               }
               , new Object[] {
   ...
   public class gx0020__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cAttractionId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [AttractionPhoto_GXI], [CategoryId], [CountryId], [AttractionName], [AttractionId], [AttractionPhoto]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00042(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H00043(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
         }
