...
namespace GeneXus.Programs {
   public class gx0020 : GXDataArea
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cAttractionId, AV7cAttractionName, AV10cCountryId) ;
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e14041_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void RF042( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00042 */
            pr_default.execute(0, new Object[] {AV6cAttractionId, lV7cAttractionName, AV10cCountryId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_44_idx = 1;
            sGXsfl_44_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_44_idx), 4, 0), 4, "0");
            SubsflControlProps_442( ) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ATTRACTIONID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A7AttractionId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cAttractionName = StringUtil.Concat( StringUtil.RTrim( AV7cAttractionName), "%", "");
         /* Using cursor H00043 */
         pr_default.execute(1, new Object[] {AV6cAttractionId, lV7cAttractionName, AV10cCountryId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202391210364777", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0020.js", "?202391210364777", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7cAttractionName',fld:'vCATTRACTIONNAME',pic:''},{av:'AV10cCountryId',fld:'vCCOUNTRYID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("ENTER","{handler:'E17042',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pAttractionId',fld:'vPATTRACTIONID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7cAttractionName',fld:'vCATTRACTIONNAME',pic:''},{av:'AV10cCountryId',fld:'vCCOUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7cAttractionName',fld:'vCATTRACTIONNAME',pic:''},{av:'AV10cCountryId',fld:'vCCOUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7cAttractionName',fld:'vCATTRACTIONNAME',pic:''},{av:'AV10cCountryId',fld:'vCCOUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7cAttractionName',fld:'vCATTRACTIONNAME',pic:''},{av:'AV10cCountryId',fld:'vCCOUNTRYID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0020__default(),
            new Object[][] {
                new Object[] {
               H00042_A9CountryId, H00042_A8AttractionName, H00042_A7AttractionId
               }
               , new Object[] {
   ...
   public class gx0020__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cAttractionId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [CountryId], [AttractionName], [AttractionId]";
