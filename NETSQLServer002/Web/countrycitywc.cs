...
namespace GeneXus.Programs {
   public class countrycitywc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20239161720457", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("countrycitywc.js", "?20239161720459", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E120F2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.countrycitywc__default(),
            new Object[][] {
                new Object[] {
               H000F2_A9CountryId, H000F2_A15CityName, H000F2_A14CityId
               }
               , new Object[] {
