   ...
   public class wwcountry : GXDataArea
   {
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A17CountryLastLine = H000D2_A17CountryLastLine[0];
               A10CountryName = H000D2_A10CountryName[0];
               A9CountryId = H000D2_A9CountryId[0];
               E140D2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202391617212462", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcountry.js", "?202391617212463", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140D2',iparms:[{av:'A9CountryId',fld:'COUNTRYID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110D2',iparms:[{av:'A9CountryId',fld:'COUNTRYID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11CountryName = "";
         H000D2_A17CountryLastLine = new short[1] ;
         H000D2_A10CountryName = new string[] {""} ;
         H000D2_A9CountryId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcountry__default(),
            new Object[][] {
                new Object[] {
               H000D2_A17CountryLastLine, H000D2_A10CountryName, H000D2_A9CountryId
               }
               , new Object[] {
      ...
      private short[] H000D2_A17CountryLastLine ;
      private string[] H000D2_A10CountryName ;
      private short[] H000D2_A9CountryId ;
