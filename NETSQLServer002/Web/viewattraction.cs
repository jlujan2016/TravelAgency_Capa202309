   ...
   public class viewattraction : GXDataArea
   {
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAttractionName_Internalname, A8AttractionName, StringUtil.RTrim( context.localUtil.Format( A8AttractionName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAttractionName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtAttractionName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_ViewAttraction.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A7AttractionId = H000G2_A7AttractionId[0];
               A8AttractionName = H000G2_A8AttractionName[0];
      ...
      protected void E110G2( )
      {
         ...
         {
            A7AttractionId = H000G3_A7AttractionId[0];
            A8AttractionName = H000G3_A8AttractionName[0];
            AssignAttri("", false, "A8AttractionName", A8AttractionName);
            AV14GXLvl7 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202391618204242", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewattraction.js", "?202391618204242", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV13Pgmname = "";
         scmdbuf = "";
         H000G2_A7AttractionId = new short[1] ;
         H000G2_A8AttractionName = new string[] {""} ;
         hsh = "";
         H000G3_A7AttractionId = new short[1] ;
         H000G3_A8AttractionName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewattraction__default(),
            new Object[][] {
                new Object[] {
               H000G2_A7AttractionId, H000G2_A8AttractionName
               }
               , new Object[] {
               H000G3_A7AttractionId, H000G3_A8AttractionName
               }
            }
         );
      ...
      private short[] H000G2_A7AttractionId ;
      private string[] H000G2_A8AttractionName ;
      private short[] H000G3_A7AttractionId ;
      private string[] H000G3_A8AttractionName ;
   ...
   public class viewattraction__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000G2", "SELECT [AttractionId], [AttractionName] FROM [Attraction] WHERE [AttractionId] = @AV12AttractionId ORDER BY [AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000G3", "SELECT [AttractionId], [AttractionName] FROM [Attraction] WHERE [AttractionId] = @AV12AttractionId ORDER BY [AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
