   ...
   public class viewcountry : GXDataArea
   {
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCountryName_Internalname, A10CountryName, StringUtil.RTrim( context.localUtil.Format( A10CountryName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtCountryName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_ViewCountry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A10CountryName = H000C2_A10CountryName[0];
      ...
      protected void E110C2( )
      {
         ...
         {
            A9CountryId = H000C3_A9CountryId[0];
            A10CountryName = H000C3_A10CountryName[0];
            AssignAttri("", false, "A10CountryName", A10CountryName);
            AV14GXLvl7 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20239161721943", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcountry.js", "?20239161721944", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H000C2_A10CountryName = new string[] {""} ;
         hsh = "";
         H000C3_A9CountryId = new short[1] ;
         H000C3_A10CountryName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcountry__default(),
            new Object[][] {
                new Object[] {
               H000C2_A9CountryId, H000C2_A10CountryName
               }
               , new Object[] {
               H000C3_A9CountryId, H000C3_A10CountryName
               }
            }
         );
      ...
      private string[] H000C2_A10CountryName ;
      private short[] H000C3_A9CountryId ;
      private string[] H000C3_A10CountryName ;
   ...
   public class viewcountry__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT [CountryId], [CountryName] FROM [Country] WHERE [CountryId] = @AV12CountryId ORDER BY [CountryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000C3", "SELECT [CountryId], [CountryName] FROM [Country] WHERE [CountryId] = @AV12CountryId ORDER BY [CountryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
