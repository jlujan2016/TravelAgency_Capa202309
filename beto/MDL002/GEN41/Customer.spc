spec_i([ trn,1,'Customer','Customer',[],eng,'18_0_4-174187' ]).
 
struct_i(1,0,[],[]).
 
level_i(1,[ 1,[ [ 1,many ] ],[ 1 ],[],[],[],[ 1 ],'ICUSTOMER',[ 1,[] ],[] ]).
...
ta_i(1,[ [ [ 1,1 ],[ 1,2 ],[ 1,3 ],[ 1,4 ],[ 1,5 ],[ 1,6 ],[ 1,16 ] ] ]).
 
las_i(1,[ [ 1,'Today',2,3,4,5,6,16 ] ]).
...
rule_i(0,datastore(1,'USER_PASSWORD','u��A�*�8OYS��Fs��up�RxVY')).
rule_i(0,datastore(1,'USER_ID',uEHOYk6k1ERudxTa)).
rule_i(0,datastore(1,'TRUSTED_CONNECTION','Yes')).
rule_i(0,datastore(1,'CS_CONNECT','First')).
rule_i(0,datastore(1,'DBMS_PORT','')).
rule_i(0,datastore(1,'CS_SERVER','JLUJAN2\MSSQLSERVERBETO')).
rule_i(0,datastore(1,'CS_DBNAME','GX_KB_TravelAgency_Capa202309_app')).
...
rule_i(0,prop('MasterPage',o(13,'General.UI.MasterUnanimoSidebar'))).
rule_i(0,prop('WEB_COMP','No')).
rule_i(0,prop(idFormLayout,'UnanimoTemplate')).
rule_i(0,prop('Theme',o(102,'TravelAgency_Capa202309'))).
rule_i(0,prop('ExternalNamespace','TravelAgency_Capa202309')).
...
rule_i(1,prompt([ 1,[ [ [],1,1 ] ],[],[],[ t(o(13,'Gx0010'),28),t(1,2) ],[],n,[] ])).
rule_i(1,rule([ a(23,[ [ 1 ],[ t(o(13,'Gx0010'),28),t(1,2) ] ]) ],[],[],[ 1 ])).
rule_i(0,rule([ a(22,[ 'Dlt','"Delete"','' ]) ],[],[],[])).
rule_i(0,maingen(41)).
rule_i(1,rule([ a(1,msg([ t('"Field Customer Email does not match the specified pattern"',3) ],[ t('OutOfRange',3) ])) ],[ t('NOT',8),t('(',0),t([ t(6,2),t('ismatch(',1) ],31),t('"^((\w+([-+.'']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*)|(\s*))$"',3),t(')',4),t(')',4) ],[ insert,update ],[ 6 ])).
rule_i(1,rule([ a(1,[ t('"Error, el nombre del cliente no debe estar vacio"',3) ]) ],[ t('null(',1),t(2,2),t(')',4) ],[ insert,update,delete,display ],[ 2 ])).
rule_i(1,rule([ a(1,[ t('"Error, el apellido del cliente no debe estar vacio"',3) ]) ],[ t('null(',1),t(3,2),t(')',4) ],[ insert,update,delete,display ],[ 3 ])).
rule_i(1,rule([ a(4,[ t('"El Telefono Vacio"',3) ]) ],[ t('null(',1),t(5,2),t(')',4) ],[ insert,update,delete,display ],[ 5 ])).
rule_i(1,rule([ a(3,[ t(16,2) ]) ],[],[ insert,update,delete,display ],[ 16 ])).
 
a_i(1,1,b,0,[],[ [],[ a(1,msg([ t('"Field Customer Email does not match the specified pattern"',3) ],[ t('OutOfRange',3) ])) ],[ t('NOT',8),t('(',0),t([ t(6,2),t('ismatch(',1) ],31),t('"^((\w+([-+.'']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*)|(\s*))$"',3),t(')',4),t(')',4) ] ]).
a_i(2,1,f,[ t(16,2),t('Enabled',3) ],[],[ [],[ t(0,3),t(';',18) ] ]).
a_i(3,1,f,16,[],[ [ insert ],[ t('Today',23),t('IF',17),t(insert,1),t(';',18) ] ]).
a_i(4,1,b,1,[],[ [],[ a(1,[ t('"Error, el nombre del cliente no debe estar vacio"',3) ]) ],[ t('null(',1),t(2,2),t(')',4) ] ]).
a_i(5,1,b,2,[],[ [],[ a(1,[ t('"Error, el apellido del cliente no debe estar vacio"',3) ]) ],[ t('null(',1),t(3,2),t(')',4) ] ]).
a_i(6,1,b,3,[],[ [],[ a(4,[ t('"El Telefono Vacio"',3) ]) ],[ t('null(',1),t(5,2),t(')',4) ] ]).
a_i(7,1,t,1,[],[ [ [ [],1,1 ] ],'ICUSTOMER',[] ]).
a_i(8,1,f,'Today',[],[ [],[ t('today(',1),t(')',4) ] ]).
 
v_i(b,i,1,6).
v_i(b,o,1,[]).
v_i(f,i,2,[]).
v_i(f,o,2,[ t(16,2),t('Enabled',3) ]).
v_i(f,i,3,'Today').
v_i(f,o,3,16).
v_i(b,i,4,2).
v_i(b,o,4,[]).
...
attri_i(16,[ 'CustomerAddedDate',date,8,0,'99/99/99',0,'Customer Added Date','',0 ]).
attri_i(6,[ 'CustomerEmail',svchar,100,0,'',0,'Customer Email','',0 ]).
attri_i(5,[ 'CustomerPhone',char,20,0,'',0,'Customer Phone','',0 ]).
attri_i(4,[ 'CustomerAddress',svchar,1024,0,'',0,'Customer Address','',0 ]).
attri_i(3,[ 'CustomerLastName',svchar,40,0,'',0,'Customer Last Name','',0 ]).
attri_i(2,[ 'CustomerName',svchar,40,0,'',0,'Customer Name','',0 ]).
attri_i(1,[ 'CustomerId',int,4,0,'ZZZ9',0,'Customer Id','',0 ]).
attri_i('Today',[ 'Gx_date',date,8,0,'99/99/99',1,'','',8 ]).
attri_i('Gxremove',[ 'GxRemove',int,1,0,'9',0,'Gx Remove','',5 ]).
attri_i('Varible1',[ varible1,int,4,0,'ZZZ9',0,varible1,'',7 ]).
attri_i('Mode',[ 'Gx_mode',char,3,0,'@!',1,'','',2 ]).
 
table_i(1,[ 'Customer',[ 1,2,3,4,5,6,16 ],'Customer','Customer' ]).
 
index_i(1,[ 'ICUSTOMER',u,[ 1 ],'ICustomer' ]).
...
upd_i(1,1,i,[ [ 2,3,4,5,6,16 ],[],'ICUSTOMER',[ [ [],1,1 ] ] ]).
upd_i(1,1,u,[ [ 2,3,4,5,6,16 ],[],'ICUSTOMER',[] ]).
upd_i(1,1,d,[ [],[],'ICUSTOMER',[] ]).
...
dom_info_i(94,[ 'Id' ]).
dom_info_i(13,[ 'GeneXus\Address' ]).
dom_info_i(53,[ 'GeneXus\Phone' ]).
dom_info_i(52,[ 'GeneXus\Email' ]).
 
a_ctrl_i(6,c,[ '"^((\w+([-+.'']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*)|(\s*))$"' ]).
...
html_sub_i(33,34,html_i(0,t(1,2))).
...
html_sub_i(38,39,html_i(0,t(2,2))).
...
html_sub_i(43,44,html_i(0,t(3,2))).
...
html_sub_i(48,49,html_i(0,t(4,2))).
...
html_sub_i(53,54,html_i(0,t(5,2))).
...
html_sub_i(58,59,html_i(0,t(6,2))).
...
html_sub_i(63,64,html_i(0,t(16,2))).
...
html_tags_i(32,'data-gx-att','att:1').
html_tags_i(34,'data-gx-att','att:1').
html_tags_i(37,'data-gx-att','att:2').
html_tags_i(39,'data-gx-att','att:2').
html_tags_i(42,'data-gx-att','att:3').
html_tags_i(44,'data-gx-att','att:3').
html_tags_i(47,'data-gx-att','att:4').
html_tags_i(49,'data-gx-att','att:4').
html_tags_i(52,'data-gx-att','att:5').
html_tags_i(54,'data-gx-att','att:5').
html_tags_i(57,'data-gx-att','att:6').
html_tags_i(59,'data-gx-att','att:6').
html_tags_i(62,'data-gx-att','att:16').
html_tags_i(64,'data-gx-att','att:16').
...
html_comp_i(6,'Class','title-container',v,[ str ]).
...
html_comp_i(9,'Class','heading-01',v,[ str ]).
...
html_comp_i(12,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
html_comp_i(14,'Class','col-xs-12',v,[ str ]).
...
html_comp_i(15,'Class','form-container',v,[ str ]).
...
html_comp_i(17,'Class','col-xs-12 col-sm-9 col-sm-offset-3 form__toolbar-cell',v,[ str ]).
...
html_comp_i(23,'Class','Button button-auxiliary ico__arrow-prev',v,[ str ]).
html_comp_i(23,'Event','Previous',v,[ str ]).
html_comp_i(23,'Caption','',d,[ str ]).
html_comp_i(23,'Title','',d,[ str ]).
html_comp_i(23,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
html_comp_i(25,'Class','Button button-auxiliary ico__arrow-next',v,[ str ]).
html_comp_i(25,'Event','Next',v,[ str ]).
html_comp_i(25,'Caption','',d,[ str ]).
html_comp_i(25,'Title','',d,[ str ]).
html_comp_i(25,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
html_comp_i(27,'Class','Button button-auxiliary ico__arrow-last',v,[ str ]).
html_comp_i(27,'Event','Last',v,[ str ]).
html_comp_i(27,'Caption','',d,[ str ]).
html_comp_i(27,'Title','',d,[ str ]).
html_comp_i(27,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
html_comp_i(31,'Class','col-xs-12 form__cell-advanced',v,[ str ]).
...
html_comp_i(34,'Font',font('Verdana',12,[]),d,[ font ]).
...
html_comp_i(36,'Class','col-xs-12 form__cell',v,[ str ]).
...
html_comp_i(39,'Colcount',40,d,[ num ]).
html_comp_i(39,'Attid',2,v,[ num ]).
...
html_comp_i(39,'Gxwidth',measure(40,chr),d,[ measure ]).
...
html_comp_i(39,'Font',font('Verdana',12,[]),d,[ font ]).
...
html_comp_i(41,'Class','col-xs-12 form__cell',v,[ str ]).
...
html_comp_i(44,'Colcount',40,d,[ num ]).
html_comp_i(44,'Attid',3,v,[ num ]).
html_comp_i(44,'Class','Attribute',v,[ str ]).
html_comp_i(44,'Controlname','Customerlastname',d,[ str ]).
...
html_comp_i(44,'Captionvalue','Last Name',d,[ str ]).
...
html_comp_i(44,'Gxwidth',measure(40,chr),d,[ measure ]).
...
html_comp_i(44,'Font',font('Verdana',12,[]),d,[ font ]).
...
html_comp_i(46,'Class','col-xs-12 form__cell',v,[ str ]).
...
html_comp_i(49,'Attid',4,v,[ num ]).
html_comp_i(49,'Class','Attribute',v,[ str ]).
html_comp_i(49,'Controlname','Customeraddress',d,[ str ]).
...
html_comp_i(49,'Captionvalue','Address',d,[ str ]).
...
html_comp_i(49,'Gxheight',measure(10,row),d,[ measure ]).
html_comp_i(49,'Ismultiline',-1,d,[ bool ]).
...
html_comp_i(49,'Font',font('Verdana',12,[]),d,[ font ]).
...
html_comp_i(51,'Class','col-xs-12 form__cell',v,[ str ]).
...
html_comp_i(54,'Font',font('Verdana',12,[]),d,[ font ]).
...
html_comp_i(56,'Class','col-xs-12 form__cell',v,[ str ]).
...
html_comp_i(59,'Colcount',80,d,[ num ]).
html_comp_i(59,'Attid',6,v,[ num ]).
html_comp_i(59,'Class','Attribute',v,[ str ]).
html_comp_i(59,'Controlname','Customeremail',d,[ str ]).
...
html_comp_i(59,'Captionvalue','Email',d,[ str ]).
html_comp_i(59,'Layoutclass','col-sm-9',v,[ str ]).
html_comp_i(59,'Controltype',2,d,[ num ]).
html_comp_i(59,'Inputtype',0,d,[ num ]).
html_comp_i(59,'Editautocomplete',0,d,[ num ]).
html_comp_i(59,'Autocorrection',0,d,[ bool ]).
html_comp_i(59,'Autocapitalization','None',d,[ str ]).
...
html_comp_i(59,'Gxwidth',measure(80,chr),d,[ measure ]).
...
html_comp_i(59,'Font',font('Verdana',12,[]),d,[ font ]).
html_comp_i(59,'Horizontalalignment',left,d,[ str ]).
...
html_comp_i(61,'Class','col-xs-12 form__cell',v,[ str ]).
...
html_comp_i(64,'Colcount',8,d,[ num ]).
html_comp_i(64,'Attid',16,v,[ num ]).
html_comp_i(64,'Class','Attribute',v,[ str ]).
html_comp_i(64,'Controlname','Customeraddeddate',d,[ str ]).
...
html_comp_i(64,'Captionvalue','Added Date',d,[ str ]).
...
html_comp_i(64,'Gxwidth',measure(8,chr),d,[ measure ]).
...
html_comp_i(64,'Font',font('Verdana',12,[]),d,[ font ]).
html_comp_i(64,'Horizontalalignment',right,d,[ str ]).
html_comp_i(64,'Gxformat',0,d,[ num ]).
html_comp_i(64,'Title','',d,[ str ]).
html_comp_i(64,'Use_datepicker',-1,d,[ bool ]).
html_comp_i(64,'Flat_datepicker',0,d,[ bool ]).
...
html_comp_i(66,'Class','col-xs-12 form__actions--fixed',v,[ str ]).
...
html_comp_i(66,'Align','Right',v,[ str ]).
html_comp_i(66,'Valign','Middle',v,[ str ]).
html_comp_i(67,'Isabstractlayoutcontrol',0,d,[ bool ]).
html_comp_i(67,'Class','gx-action-group',v,[ str ]).
...
html_comp_i(69,'Class','Button button-primary',v,[ str ]).
html_comp_i(69,'Event','Enter',v,[ str ]).
html_comp_i(69,'Caption','Confirm',d,[ str ]).
html_comp_i(69,'Title','Confirm',d,[ str ]).
html_comp_i(69,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
html_comp_i(71,'Class','Button button-tertiary',v,[ str ]).
html_comp_i(71,'Event','Cancel',v,[ str ]).
html_comp_i(71,'Caption','Cancel',d,[ str ]).
html_comp_i(71,'Title','Cancel',d,[ str ]).
html_comp_i(71,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
html_comp_i(73,'Class','Button button-tertiary',v,[ str ]).
html_comp_i(73,'Event','Delete',v,[ str ]).
html_comp_i(73,'Caption','Delete',d,[ str ]).
html_comp_i(73,'Title','Delete',d,[ str ]).
html_comp_i(73,'Font',font('Microsoft Sans Serif',10,[]),d,[ font ]).
...
lit_i(34,1,t(1,2),[ ctlname(1),ctrltype(edit,34),pos(34),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
lit_i(33,1,div(33),[ ctlname('') ]).
lit_i(32,1,div(32),[ ctlname('') ]).
lit_i(31,1,div(31),[ ctlname('') ]).
lit_i(30,1,div(30),[ ctlname('') ]).
lit_i(39,1,t(2,2),[ ctlname(2),ctrltype(edit,39),pos(39),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
lit_i(38,1,div(38),[ ctlname('') ]).
lit_i(37,1,div(37),[ ctlname('') ]).
lit_i(36,1,div(36),[ ctlname('') ]).
lit_i(35,1,div(35),[ ctlname('') ]).
lit_i(44,1,t(3,2),[ ctlname(3),ctrltype(edit,44),pos(44),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
lit_i(43,1,div(43),[ ctlname('') ]).
lit_i(42,1,div(42),[ ctlname('') ]).
lit_i(41,1,div(41),[ ctlname('') ]).
lit_i(40,1,div(40),[ ctlname('') ]).
lit_i(49,1,t(4,2),[ ctlname(4),ctrltype(edit,49),pos(49),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
lit_i(48,1,div(48),[ ctlname('') ]).
lit_i(47,1,div(47),[ ctlname('') ]).
lit_i(46,1,div(46),[ ctlname('') ]).
lit_i(45,1,div(45),[ ctlname('') ]).
lit_i(54,1,t(5,2),[ ctlname(5),ctrltype(edit,54),pos(54),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
lit_i(53,1,div(53),[ ctlname('') ]).
lit_i(52,1,div(52),[ ctlname('') ]).
lit_i(51,1,div(51),[ ctlname('') ]).
lit_i(50,1,div(50),[ ctlname('') ]).
lit_i(59,1,t(6,2),[ ctlname(6),ctrltype(edit,59),pos(59),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
lit_i(58,1,div(58),[ ctlname('') ]).
lit_i(57,1,div(57),[ ctlname('') ]).
lit_i(56,1,div(56),[ ctlname('') ]).
lit_i(55,1,div(55),[ ctlname('') ]).
lit_i(64,1,t(16,2),[ ctlname(16),ctrltype(edit,64),pos(64),ispwd(0),e2n(1),width(0),rect(0,0,10,10),title('Nothing') ]).
...
att_prop_i(2,1,'ExternalName','CustomerId',d).
att_prop_i(2,1,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,1,'EmptyAsNull','Yes',d).
att_prop_i(2,1,idBasedOn,94,v).
att_prop_i(2,1,'AUTONUMBER','-1',d).
...
att_prop_i(2,1,'VarServiceExtName','',d).
att_prop_i(2,1,'FullName','CustomerId',v).
att_prop_i(2,2,'ExternalName','CustomerName',d).
att_prop_i(2,2,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,2,'EmptyAsNull','Yes',d).
att_prop_i(2,2,idBasedOn,'',d).
...
att_prop_i(2,2,'VarServiceExtName','',d).
att_prop_i(2,2,'FullName','CustomerName',v).
att_prop_i(2,3,'ExternalName','CustomerLastName',d).
att_prop_i(2,3,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,3,'EmptyAsNull','Yes',d).
att_prop_i(2,3,idBasedOn,'',d).
att_prop_i(2,3,'ATT_INITIAL_VALUE','',d).
att_prop_i(2,3,'DB_NLS_SUPPORT','Yes',d).
att_prop_i(2,3,'AttRegEx','',d).
att_prop_i(2,3,'AttValidationFailedMsg','',d).
att_prop_i(2,3,'DownloadOffline','0',d).
att_prop_i(2,3,'VarServiceExtName','',d).
att_prop_i(2,3,'FullName','CustomerLastName',v).
att_prop_i(2,4,'ExternalName','CustomerAddress',d).
att_prop_i(2,4,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,4,'EmptyAsNull','Yes',d).
att_prop_i(2,4,idBasedOn,13,v).
att_prop_i(2,4,'ATT_INITIAL_VALUE','',d).
att_prop_i(2,4,'DB_NLS_SUPPORT','Yes',d).
att_prop_i(2,4,'AttRegEx','',d).
att_prop_i(2,4,'AttValidationFailedMsg','',d).
att_prop_i(2,4,'DownloadOffline','0',d).
att_prop_i(2,4,'VarServiceExtName','',d).
att_prop_i(2,4,'FullName','CustomerAddress',v).
att_prop_i(2,5,'ExternalName','CustomerPhone',d).
att_prop_i(2,5,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,5,'EmptyAsNull','Yes',d).
att_prop_i(2,5,idBasedOn,53,v).
...
att_prop_i(2,5,'VarServiceExtName','',d).
att_prop_i(2,5,'FullName','CustomerPhone',v).
att_prop_i(2,6,'ExternalName','CustomerEmail',d).
att_prop_i(2,6,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,6,'EmptyAsNull','Yes',d).
att_prop_i(2,6,idBasedOn,52,v).
att_prop_i(2,6,'ATT_INITIAL_VALUE','',d).
att_prop_i(2,6,'DB_NLS_SUPPORT','Yes',d).
att_prop_i(2,6,'AttRegEx','^((\w+([-+.'']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*)|(\s*))$',d).
att_prop_i(2,6,'AttValidationFailedMsg','GXM_DoesNotMatchRegExp',d).
att_prop_i(2,6,'DownloadOffline','0',d).
att_prop_i(2,6,'VarServiceExtName','',d).
att_prop_i(2,6,'FullName','CustomerEmail',v).
att_prop_i(2,16,'ExternalName','CustomerAddedDate',d).
att_prop_i(2,16,'ExternalNamespace','TravelAgency_Capa202309',d).
att_prop_i(2,16,'EmptyAsNull','Yes',d).
att_prop_i(2,16,idBasedOn,'',d).
att_prop_i(2,16,'ATT_INITIAL_VALUE','',d).
att_prop_i(2,16,'AttRegEx','',d).
att_prop_i(2,16,'AttValidationFailedMsg','',d).
att_prop_i(2,16,idDATEFORMAT,idDATEFORMAT_SHORT,d).
att_prop_i(2,16,'DownloadOffline','0',d).
att_prop_i(2,16,'VarServiceExtName','',d).
att_prop_i(2,16,'FullName','CustomerAddedDate',v).
...
tbl_att_prop_i(2,1,5,'AllowNulls',n).
tbl_att_prop_i(2,1,16,'AllowNulls',n).
 
 
 
 
 
trn_level_i(1,[ [ 1,2,3,4,5,6,16 ],'Customer','Customer','Customer','',2 ]).
...
pgm_parm_i(web,3,'GX0010',[ [ int,4,0,0 ] ],[ [ pCustomerId,out,[] ] ]).
 
pgm_callprotocol_i(trn,1,'CUSTOMER','INTERNAL','Unsecure').
pgm_callprotocol_i(web,3,'GX0010','INTERNAL','Unsecure').
